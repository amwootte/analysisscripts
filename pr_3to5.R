####################
#
# 3^5 Analysis with Precipitation change
#
...
for(i in 1:length(filelist)){
  ...
  for(y in 1:length(years)){
    ...
    totalvals = apply(tempdat,c(1,2),sum,na.rm=TRUE)
    rm(tempdat)
...
diffpr = ((prfut-prpast)/prpast)*100
...
zlimobs = c(0,2100)
breaksobs = c(seq(0,2100,by=100))
colorbarobs = colorRampPalette(c("grey96","lightgreen","darkgreen"))(length(breaksobs)-1)

pdf("/home/woot0002/IndividualMembers_pr_ratio.pdf",onefile=TRUE,width=8,height=8)
...
zlimdiff = c(-20,20)
breaksdiff = c(seq(-20,20,by=5))
colorbardiff = colorRampPalette(c("chocolate4","grey96","darkgreen"))(length(breaksdiff)-1)

zlimobs = c(100,2000)
breaksobs = c(seq(100,2000,by=100))
colorbarobs = colorRampPalette(c("grey96","lightgreen","darkgreen"))(length(breaksobs)-1)

pdf("/home/woot0002/Group1members_pr_ratio.pdf",width=8,height=8,onefile=TRUE)
...
pdf("/home/woot0002/Group2Members_pr.pdf",onefile=TRUE,width=8,height=8)
...
pdf("/home/woot0002/Group3Members_pr.pdf",onefile=TRUE,width=8,height=8)
...
pdf("/home/woot0002/IndividualMembers_pr_OK.pdf",onefile=TRUE,width=9,height=6)
...
zlimdiff = c(-10,10)
breaksdiff = c(seq(-10,10,by=2))
colorbardiff = colorRampPalette(c("chocolate4","grey96","darkgreen"))(length(breaksdiff)-1)

zlimobs = c(100,1500)
breaksobs = c(seq(100,1500,by=100))
colorbarobs = colorRampPalette(c("grey96","lightgreen","darkgreen"))(length(breaksobs)-1)

pdf("/home/woot0002/Group1Members_pr_OK.pdf",onefile=TRUE,width=9,height=6)
...
zlimobs = c(100,1800)
breaksobs = c(seq(100,1800,by=100))
colorbarobs = colorRampPalette(c("grey96","lightgreen","darkgreen"))(length(breaksobs)-1)

pdf("/home/woot0002/Group2Members_pr_OK.pdf",onefile=TRUE,width=9,height=6)
...
pdf("/home/woot0002/Group3Members_pr_OK.pdf",onefile=TRUE,width=9,height=6)
