...
# Geneva Gray ran this for wind direction on 12/15/2015
#################################
#
...
files = system(paste("ls /projdata/dcerp/DSdata/idaho_v2G/SE/",variable,"*.nc",sep=""),intern=TRUE)
...
fileout = paste("idaho_v2G/",variable,".nc",sep="")
