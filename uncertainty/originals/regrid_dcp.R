...
#files = c(
#system(paste("ls ",datasetname,"/res15km/old/*",variable,"*grid_hist.nc",sep=""),intern=TRUE)
#system(paste("ls ",datasetname,"/SE/*-a2-",variable,"*grid.nc",sep=""),intern=TRUE)
#system(paste("ls ",datasetname,"/SE/*-a1fi-",variable,"*grid.nc",sep=""),intern=TRUE),
#system(paste("ls ",datasetname,"/SE/*-a1b-",variable,"*grid.nc",sep=""),intern=TRUE)
#system(paste("ls ",datasetname,"/SE/*-b1-",variable,"*grid.nc",sep=""),intern=TRUE)
#)

#files=files[c(1,4,12)]

files =  system(paste("ls ",datasetname,"/SE/cgcm3_t47-*",variable,"*grid.nc",sep=""),intern=TRUE)

#filesin = paste(substr(files,1,4),substr(files,17,nchar(files)),sep="")
#files=filesin
#files = system(paste("ls ",datasetname,"/miroc_hi*",variable,"*grid_hist.nc",sep=""),intern=TRUE)
...
lon = get.var.ncdf(test,lonname)-360
...
if(varname=="tmax" | varname=="tmin") varunits="degrees_C"
...
#fileout = paste(filesplit[1],"/",filesplit[2],"/res15km/",filesplit[3],sep="")
