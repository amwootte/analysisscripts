...
files = c(
#system(paste("ls ",datasetname,"/*",variable,"*rcp26*.nc",sep=""),intern=TRUE),
#system(paste("ls ",datasetname,"/*",variable,"*rcp45*.nc",sep=""),intern=TRUE),
#system(paste("ls ",datasetname,"/*",variable,"*rcp85*.nc",sep=""),intern=TRUE)

system(paste("ls ",datasetname,"/SE/*",variable,"*historical*.nc",sep=""),intern=TRUE)
)
