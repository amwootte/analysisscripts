...
datasetname = "cmip5_bcca"
variable = "pr"

files = c(
system(paste("ls ",datasetname,"/SE/*",variable,"*rcp26*.nc",sep=""),intern=TRUE)
#system(paste("ls ",datasetname,"/SE/*",variable,"*rcp45*.nc",sep=""),intern=TRUE),
#system(paste("ls ",datasetname,"/SE/*",variable,"*rcp60*.nc",sep=""),intern=TRUE),
#system(paste("ls ",datasetname,"/SE/*",variable,"*rcp85*.nc",sep=""),intern=TRUE)

#system(paste("ls ",datasetname,"/*sresb1*",variable,"*.nc",sep=""),intern=TRUE),
#system(paste("ls ",datasetname,"/*sresa2*",variable,"*.nc",sep=""),intern=TRUE),
#system(paste("ls ",datasetname,"/*sresa1b*",variable,"*.nc",sep=""),intern=TRUE)
)
...
message("File regrid began at ",Sys.time()," for file: ",files[1])
