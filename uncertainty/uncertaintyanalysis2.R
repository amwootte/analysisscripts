...
fileout = paste("uncertainty/SE/",anfilepath,"/",varname,"_analysis_fix2.nc",sep="")
...
pdf(paste("uncertainty/SE/",anfilepath,"/",varname,"_contributionplots_fix2.pdf",sep=""),height=10,width=17,onefile=TRUE)
