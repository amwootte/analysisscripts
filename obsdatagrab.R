...
for(y in 1950:2005){
  ...
  filename1 = paste("/data/static_web/SPTC_Climate_Projections_Data_and_Images/Data/Average_temperatures/Gridpoint_netcdf_all_domain/Observations/Livneh/Max_Min_temperatures_Livneh_",y,".nc",sep="") 
  filename2 = paste("/data/static_web/SPTC_Climate_Projections_Data_and_Images/Data/Average_temperatures/Gridpoint_netcdf_all_domain/Observations/Livneh/monthly_average_temperatures_SC_US_Livneh_",y,".nc",sep="")
  filename3 = paste("/data/static_web/SPTC_Climate_Projections_Data_and_Images/Data/Average_precipitation/Gridpoint_netcdf_all_domain/Observations/Livneh/monthly_precip_accum_SC_US_Livneh_",y,".nc",sep="")
...
write.table(outputdat,paste("/home/woot0002/REUproject/Livneh_historical_climate_",locationname,".csv",sep=""),row.names=FALSE,sep=",") # write out file for location
