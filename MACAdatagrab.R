...
monthyear = seq(as.Date("1950-01-15"),as.Date("2005-12-15"),by="month") # set time dimension, separate columns for monthyear, month, and year
...
for(y in 1950:2005){
  ...
  filename1 = paste("/data/static_web/SPTC_Climate_Projections_Data_and_Images/Data/Average_temperatures/Gridpoint_netcdf_all_domain/CMIP5_MACA/",GCM,"/historical/Max_Min_temperatures_MACA_",GCM,"_historical_",y,".nc",sep="") 
  filename2 = paste("/data/static_web/SPTC_Climate_Projections_Data_and_Images/Data/Average_temperatures/Gridpoint_netcdf_all_domain/CMIP5_MACA/",GCM,"/historical/monthly_average_temperature_SC_US_",GCM,"_historical_",y,".nc",sep="")
  filename3 = paste("/data/static_web/SPTC_Climate_Projections_Data_and_Images/Data/Average_precipitation/Gridpoint_netcdf_all_domain/CMIP5_MACA/",GCM,"/historical/monthly_precip_accum_SC_US_",GCM,"_historical_",y,".nc",sep="")
...
write.table(outputdat,paste("/home/woot0002/REUproject/",GCM,"_historical_climate_",locationname,".csv",sep=""),row.names=FALSE,sep=",") # write out file for location
