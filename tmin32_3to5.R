####################
#
# 3^5 Analysis with Number of Day the Low is below freezing
#
...
for(i in 1:length(filelist)){
  ...
  for(y in 1:length(years)){
    ...
    totalvals = apply(tempcount,c(1,2),sum,na.rm=TRUE)
...
zlimdiff = c(-75,75)
breaksdiff = c(seq(-75,75,by=5))
colorbardiff = colorRampPalette(c("red","grey96","blue"))(length(breaksdiff)-1)

zlimobs = c(0,370)
breaksobs = c(seq(0,370,by=10))
colorbarobs = colorRampPalette(c("darkred","red","orange","yellow2"))(length(breaksobs)-1)

pdf("/home/woot0002/IndividualMembers_tmin32.pdf",onefile=TRUE,width=8,height=8)
...
zlimdiff = c(-45,45)
breaksdiff = c(seq(-45,45,by=5))
colorbardiff = colorRampPalette(c("red","grey96","blue"))(length(breaksdiff)-1)

zlimobs = c(0,340)
breaksobs = c(seq(0,340,by=20))
colorbarobs = colorRampPalette(c("darkred","red","orange","yellow2"))(length(breaksobs)-1)

pdf("/home/woot0002/Group1members_tmin32.pdf",width=8,height=8,onefile=TRUE)
...
pdf("/home/woot0002/Group2Members_tmin32.pdf",onefile=TRUE,width=8,height=8)
...
zlimdiff = c(-65,65)
breaksdiff = c(seq(-65,65,by=5))
colorbardiff = colorRampPalette(c("red","grey96","blue"))(length(breaksdiff)-1)

zlimobs = c(0,380)
breaksobs = c(seq(0,380,by=20))
colorbarobs = colorRampPalette(c("darkred","red","orange","yellow2"))(length(breaksobs)-1)

pdf("/home/woot0002/Group3Members_tmin32.pdf",onefile=TRUE,width=8,height=8)
...
zlimdiff = c(-35,35)
breaksdiff = c(seq(-35,35,by=5))
colorbardiff = colorRampPalette(c("red","grey96","blue"))(length(breaksdiff)-1)

zlimobs = c(15,140)
breaksobs = c(seq(15,140,by=1))
colorbarobs = colorRampPalette(c("darkred","red","orange","yellow2"))(length(breaksobs)-1)

pdf("/home/woot0002/IndividualMembers_tmin32_OK.pdf",onefile=TRUE,width=9,height=6)
...
zlimdiff = c(-30,30)
breaksdiff = c(seq(-30,30,by=3))
colorbardiff = colorRampPalette(c("red","grey96","blue"))(length(breaksdiff)-1)

zlimobs = c(20,140)
breaksobs = c(seq(20,140,by=10))
colorbarobs = colorRampPalette(c("darkred","red","orange","yellow2"))(length(breaksobs)-1)

pdf("/home/woot0002/Group1Members_tmin32_OK.pdf",onefile=TRUE,width=9,height=6)
...
zlimobs = c(10,140)
breaksobs = c(seq(10,140,by=10))
colorbarobs = colorRampPalette(c("darkred","red","orange","yellow2"))(length(breaksobs)-1)

pdf("/home/woot0002/Group2Members_tmin32_OK.pdf",onefile=TRUE,width=9,height=6)
...
pdf("/home/woot0002/Group3Members_tmin32_OK.pdf",onefile=TRUE,width=9,height=6)
