#####
# CLIMDEX calculation helper functions
...
#####
# quantile frequency sum calculator

quantfreqsum = function(inputdata,qval = 50.8){
  inputvals = ifelse(inputdata>qval,1,0)
  sum(inputvals,na.rm=TRUE)
}



#####
# quantile sum calculator

quantsum = function(inputdata,qval = 50.8){
  inputvals = inputdata[which(inputdata>qval)]
  sum(inputvals,na.rm=TRUE)
}
