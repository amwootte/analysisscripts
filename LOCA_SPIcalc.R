...
tempres=1
filesin = system("ls /data4/data/DS_proj/LOCA/prmon/historical/*.nc",intern=TRUE)
...
for(i in 1:length(filesin)){
  ...
  filenameout = paste("/data4/data/DS_proj/LOCA/SPI",tempres,"/historical/",filenamepart,sep="")
