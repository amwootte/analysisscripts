...
source("scripts/springpheno_v0.3.R")

tasmaxfile = "/data2/3to5/I35/tasmax/Livneh/tasmax_day_livneh_historical_r0i0p0_SCCSC0p1_19810101-20051231.nc"
tasminfile = "/data2/3to5/I35/tasmin/Livneh/tasmin_day_livneh_historical_r0i0p0_SCCSC0p1_19810101-20051231.nc"
...
save(list=c("LFSEIout","EFSEIout","FLIout","FBIout","DMGout","EFSout","LFSout","lastfreezeout","years","lat","lon"),file="Livneh_SIxresults_v0.3.Rdata")
