####################
#
# 3^5 Analysis with Precipitation over 1 inch change
#
...
pdf("/home/woot0002/IndividualMembers_pr25_ratio.pdf",onefile=TRUE,width=8,height=8)
...
pdf("/home/woot0002/Group1members_pr25.pdf",width=8,height=8,onefile=TRUE)
...
pdf("/home/woot0002/Group2Members_pr25.pdf",onefile=TRUE,width=8,height=8)
...
pdf("/home/woot0002/Group3Members_pr25.pdf",onefile=TRUE,width=8,height=8)
...
zlimobs = c(0,15)
breaksobs = c(seq(0,15,by=3))
colorbarobs = colorRampPalette(c("grey96","lightgreen","darkgreen"))(length(breaksobs)-1)

pdf("/home/woot0002/IndividualMembers_pr25_NM.pdf",onefile=TRUE,width=6,height=6)
...
zlimdiff = c(-2,2)
breaksdiff = c(seq(-2,2,by=0.1))
colorbardiff = colorRampPalette(c("chocolate4","grey96","darkgreen"))(length(breaksdiff)-1)

zlimobs = c(0,8)
breaksobs = c(seq(0,8,by=1))
colorbarobs = colorRampPalette(c("grey96","lightgreen","darkgreen"))(length(breaksobs)-1)

pdf("/home/woot0002/Group1Members_pr25_NM.pdf",onefile=TRUE,width=6,height=6)
...
zlimdiff = c(-3,3)
breaksdiff = c(seq(-3,3,by=0.2))
colorbardiff = colorRampPalette(c("chocolate4","grey96","darkgreen"))(length(breaksdiff)-1)

zlimobs = c(0,10)
breaksobs = c(seq(0,10,by=1))
colorbarobs = colorRampPalette(c("grey96","lightgreen","darkgreen"))(length(breaksobs)-1)

pdf("/home/woot0002/Group2Members_pr25_NM.pdf",onefile=TRUE,width=6,height=6)
...
zlimobs = c(0,12)
breaksobs = c(seq(0,12,by=1))
colorbarobs = colorRampPalette(c("grey96","lightgreen","darkgreen"))(length(breaksobs)-1)

pdf("/home/woot0002/Group3Members_pr25_NM.pdf",onefile=TRUE,width=6,height=6)
