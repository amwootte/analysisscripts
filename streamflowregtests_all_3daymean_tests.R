...
load("/home/woot0002/streamflowtests_3daymovingmean.Rdata")
...
plot(density(log(ymat)),xlab="ln(streamflow)",main="Training period streamflow pdfs")
...
for(c in 0:(length(allnames)-1)){
  ...
  corswithin = list()
  RMSEswithin = list()
  pdf(paste("/home/woot0002/streamflowregressiontests_3daymovingmean_",c,"varsout.pdf",sep=""),onefile=TRUE,width=5,height=5)
...
save(list=c("varsusedall","corsusedall","RMSEsusedall"),file="/home/woot0002/streamflowtests_3daymovingmean.Rdata")
