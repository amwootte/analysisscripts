...
streamflow = read.table(paste("/home/woot0002/streamflow_",streamflowID,sep=""),header=TRUE,sep="\t",fill=TRUE)
...
save(list=c("fit"),file=paste("/home/woot0002/",obsID,"streamflowfit_",streamflowID,".Rdata",sep=""))
