...
step7 = function(step1_filename,histnotes,projnotes,loc_name,loc_lon,loc_lat){
...
filename = paste("/data2/3to5/I35/point_output/",varname,"_",loc_name,"_",difftype,"_",futureperiod[1],"-",futureperiod[2],".csv",sep="")
...
step7(step1_filename=parsed.args$filename,histnotes=parsed.args$histnotes,projnotes = parsed.args$projnotes,loc_name=parsed.args$loc_name,loc_lon=parsed.args$loc_lon,loc_lat=parsed.args$loc_lat)
