...
### Heatmap
pdf(paste("/home/woot0002/DS_ind/NRMSEheatmap_combined_GCM_hist_v4pronly_",type,".pdf",sep=""),height=18,width=18)
...
pdf(paste("/home/woot0002/DS_ind/NRMSEheatmap_combined_LOCA_hist_v4pronly_",type,".pdf",sep=""),height=18,width=18)
...
#topend=1
### Heatmap
pdf(paste("/home/woot0002/DS_ind/NRMSEheatmap_combined_GCM_change_v4pronly_",type,".pdf",sep=""),height=18,width=18)
ggplot(data = melted_cormat_GCM, aes(Var2, Var1, fill = value))+
  geom_tile(color = "white")+
  scale_fill_gradient2(low = "blue", high = "red", mid = "gray96", 
                       midpoint = topend/2, limit = c(0,topend), breaks=seq(0,topend,by=0.1), space = "Lab", 
...
pdf(paste("/home/woot0002/DS_ind/NRMSEheatmap_combined_LOCA_change_v4pronly_",type,".pdf",sep=""),height=18,width=18)
ggplot(data = melted_cormat_LOCA, aes(Var2, Var1, fill = value))+
  geom_tile(color = "white")+
  scale_fill_gradient2(low = "blue", high = "red", mid = "gray96", 
                       midpoint = topend/2, limit = c(0,topend), breaks=seq(0,topend,by=0.1), space = "Lab", 
...
save(list=c("NRMSEhmatout_LOCA","NRMSEcmatout_LOCA","LOCAhdat","simnames_LOCA"),file=paste("/home/woot0002/DS_ind/RMSEmats_combohc_LOCA_v4pronly_",type,".Rdata",sep=""))
save(list=c("NRMSEhmatout_GCM","NRMSEcmatout_GCM","GCMhdat","simnames_GCM"),file=paste("/home/woot0002/DS_ind/RMSEmats_combohc_GCM_v4pronly_",type,".Rdata",sep=""))
