...
biasprbar_LOCA = colorramp(c(LOCA_bias_pr_WUpr,LOCA_bias_pr_WUtmax),colorchoice="bluetored",Blimit=30,type="difference",use_fixed_scale = TRUE,fixed_scale=c(-800,800))
...
biasprbar_GCM = colorramp(c(GCM_bias_pr_WUpr,GCM_bias_pr_WUtmax),colorchoice="bluetored",Blimit=30,type="difference",use_fixed_scale = FALSE)
biastmaxbar_LOCA = colorramp(c(LOCA_bias_tmax_WUpr,LOCA_bias_tmax_WUtmax),colorchoice="bluetored",Blimit=20,type="difference",use_fixed_scale = FALSE)
...
pdf(paste("GCMprmaps_WU",WUs[w],"_SA",SAs[s],"_customscale.pdf",sep=""),width=25,height=20)
par(mfrow=c(4,5))
for(i in 1:20){
  if(i>=1 & i<=5){
...
pdf(paste("LOCAprmaps_WU",WUs[w],"_SA",SAs[s],"_customscale.pdf",sep=""),width=25,height=20)
par(mfrow=c(4,5))
for(i in 1:20){
  if(i>=1 & i<=5){
    testsfc = list(x=lon,y=lat,z=LOCA_bias_pr_WUtmax[,,i,w,s])   
  ...
  if(i>=12 & i<=15){
    I=i-10
    testsfc = list(x=lon,y=lat,z=LOCA_bias_pr_WUpr[,,I,w,s])   
...
for(i in 1:20){
  if(i>=1 & i<=5){
    testsfc = list(x=lon,y=lat,z=LOCA_bias_tmax_WUtmax[,,i,w,s])   
  ...
  if(i>=12 & i<=15){
    I=i-10
    testsfc = list(x=lon,y=lat,z=LOCA_bias_tmax_WUpr[,,I,w,s])   
