...
save(list=c("normGCMhRMSEmat","GCMhdat","GCMgroup","normGCMcRMSEmat","GCMpdat","GCMpgroup"),file=paste("/home/woot0002/RMSEfiles/",var,"_RMSEmats_combo_GCM_v4_",type,".Rdata",sep=""))
save(list=c("normLOCAhRMSEmat","LOCAhdat","LOCAgroup","normLOCAcRMSEmat","LOCApdat","LOCApgroup"),file=paste("/home/woot0002/RMSEfiles/",var,"_RMSEmats_combo_LOCA_v4_",type,".Rdata",sep=""))
...
### Heatmap
pdf(paste("/home/woot0002/DS_ind/",var,"_NRMSEheatmap_GCM_hist_v4_",type,".pdf",sep=""),height=18,width=18)
...
pdf(paste("/home/woot0002/DS_ind/",var,"_NRMSEheatmap_LOCA_hist_v4_",type,".pdf",sep=""),height=18,width=18)
...
### Heatmap
pdf(paste("/home/woot0002/DS_ind/",var,"_NRMSEheatmap_GCM_change_v4_",type,".pdf",sep=""),height=18,width=18)
ggplot(data = melted_cormatGCM, aes(Var2, Var1, fill = value))+
  geom_tile(color = "white")+
  scale_fill_gradient2(low = "blue", high = "red", mid = "gray96", 
                       midpoint = topend/2, limit = c(0,topend), breaks=seq(0,topend,by=0.1), space = "Lab", 
...
pdf(paste("/home/woot0002/DS_ind/",var,"_NRMSEheatmap_LOCA_change_v4_",type,".pdf",sep=""),height=18,width=18)
ggplot(data = melted_cormatLOCA, aes(Var2, Var1, fill = value))+
  geom_tile(color = "white")+
  scale_fill_gradient2(low = "blue", high = "red", mid = "gray96", 
                       midpoint = topend/2, limit = c(0,topend), breaks=seq(0,topend,by=0.1), space = "Lab", 
