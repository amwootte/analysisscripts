...
startidx = which(names(LOCAweights)==1)
colsoff = startidx-1
endidx = ncol(LOCAweights)
...
for(i in 1:26){
  ...
  GCMBMAhistmean_pr[,,(b-colsoff)]=GCMBMAmean_hist
  LOCABMAhistmean_pr[,,(b-colsoff)]=LOCABMAmean_hist
}
...
for(b in startidx:endidx){
  ...
  GCMBMAhistmean_tmax[,,(b-colsoff)]=GCMBMAmean_hist
  LOCABMAhistmean_tmax[,,(b-colsoff)]=LOCABMAmean_hist
}
...
for(b in startidx:endidx){
  ...
  GCMBMAchangemean_pr[,,(b-colsoff)]=GCMBMAmean_change
  LOCABMAchangemean_pr[,,(b-colsoff)]=LOCABMAmean_change
}
...
for(b in startidx:endidx){
  ...
  GCMBMAchangemean_tmax[,,(b-colsoff)]=GCMBMAmean_change
  LOCABMAchangemean_tmax[,,(b-colsoff)]=LOCABMAmean_change
}
...
for(b in startidx:endidx){
  ...
  GCMBMAchangevar_pr[,,(b-colsoff)]=GCMBMAvar_change
  LOCABMAchangevar_pr[,,(b-colsoff)]=LOCABMAvar_change
  message("Finished calcs for BMA member: ",b-colsoff," / ",100)
}
...
for(b in startidx:endidx){
  ...
  GCMBMAchangevar_tmax[,,(b-colsoff)]=GCMBMAvar_change
  LOCABMAchangevar_tmax[,,(b-colsoff)]=LOCABMAvar_change
  message("Finished calcs for BMA member: ",b-colsoff," / ",100)
}
