...
save(list=c("RMSEmat","normRMSEmat","metadat","allfiles"),file=paste("/home/woot0002/RMSEfiles/",var,"_RMSEmats.Rdata",sep=""))
...
### Heatmap
pdf(paste(var,"_NRMSEheatmap.pdf",sep=""),height=15,width=15)
