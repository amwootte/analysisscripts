####################
#
# 3^5 Analysis with Number of Days with Rain
#
...
#  1. Gather and convert daily tasmax into annual total rainfall
...
zlimdiff = c(-12,12)
breaksdiff = c(seq(-12,12,by=1))
colorbardiff = colorRampPalette(c("chocolate4","grey96","darkgreen"))(length(breaksdiff)-1)

zlimobs = c(0,180)
breaksobs = c(seq(0,180,by=10))
colorbarobs = colorRampPalette(c("grey96","lightgreen","darkgreen"))(length(breaksobs)-1)

pdf("/home/woot0002/Group1members_mdrn.pdf",width=8,height=8,onefile=TRUE)
...
pdf("/home/woot0002/Group2Members_mdrn.pdf",onefile=TRUE,width=8,height=8)
...
zlimdiff = c(-16,16)
breaksdiff = c(seq(-16,16,by=2))
colorbardiff = colorRampPalette(c("chocolate4","grey96","darkgreen"))(length(breaksdiff)-1)

zlimobs = c(0,220)
breaksobs = c(seq(0,220,by=10))
colorbarobs = colorRampPalette(c("grey96","lightgreen","darkgreen"))(length(breaksobs)-1)

pdf("/home/woot0002/Group3Members_mdrn.pdf",onefile=TRUE,width=8,height=8)
...
############################################################
####################################################
# Mask to desired states

OKoutline = data.frame(map("state",regions="oklahoma",plot=FALSE)[c("x","y")])
#OKoutline = data.frame(map("state",regions="new mexico",plot=FALSE)[c("x","y")])
rows = 1:length(lon)
cols = 1:length(lat)
...
lonOKrange[2] = ceiling(lonOKrange[2])+0.25
...
zlimdiff = c(-15,15)
breaksdiff = c(seq(-15,15,by=1))
colorbardiff = colorRampPalette(c("chocolate4","grey96","darkgreen"))(length(breaksdiff)-1)

zlimobs = c(0,200)
breaksobs = c(seq(0,200,by=10))
colorbarobs = colorRampPalette(c("grey96","lightgreen","darkgreen"))(length(breaksobs)-1)

pdf("/home/woot0002/IndividualMembers_mdrn_OK.pdf",onefile=TRUE,width=9,height=6)
...
zlimdiff = c(-7,7)
breaksdiff = c(seq(-7,7,by=1))
colorbardiff = colorRampPalette(c("chocolate4","grey96","darkgreen"))(length(breaksdiff)-1)

zlimobs = c(0,140)
breaksobs = c(seq(0,140,by=10))
colorbarobs = colorRampPalette(c("grey96","lightgreen","darkgreen"))(length(breaksobs)-1)

pdf("/home/woot0002/Group1Members_mdrn_OK.pdf",onefile=TRUE,width=9,height=6)
...
pdf("/home/woot0002/Group2Members_mdrn_OK.pdf",onefile=TRUE,width=9,height=6)
...
pdf("/home/woot0002/Group3Members_mdrn_OK.pdf",onefile=TRUE,width=9,height=6)
