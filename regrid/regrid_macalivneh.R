...
args = c("macalivneh","pr")

dataset = args[1]
var = args[2]

files = system(paste("ls /home/woot0002/MACA_LIVNEH/*",var,"*.nc",sep=""),intern=TRUE)
...
for(f in 1:length(files)){
  ...
  if(var!="pr"){
  nc <- nc_create(paste("/home/woot0002/MACA_LIVNEH/regrid/",fileout,sep="") ,  list(var1d,var4d) )
  ...
  nc_close(nc)
    ...
    nc <- nc_create(paste("/home/woot0002/MACA_LIVNEH/regrid/",fileout,sep="") ,  list(var1d,var2d,var3d,var4d,var5d) )
