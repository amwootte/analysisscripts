...
files = system(paste("ls /home/woot0002/BCCA/*",var,"*.nc",sep=""),intern=TRUE)
...
for(f in 1:length(files)){
  ...
  if(var!="pr"){
  nc <- nc_create(paste("/home/woot0002/BCCA/regrid/",fileout,sep="") ,  list(var1d,var2d) )
  ...
  nc_close(nc)
    ...
    nc <- nc_create(paste("/home/woot0002/BCCA/regrid/",fileout,sep="") ,  list(var1d,var2d,var3d,var4d,var5d) )
