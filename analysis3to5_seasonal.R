...
seasonin = "SON" # which season should be calculated
...
plot=FALSE
savebreakdowns = FALSE
if(plot==FALSE){
  save(list=c("projlist","histlist","diffs","diffsg1"),file=paste("projchange_",varname,"_",seasonin,"_",difftype,".Rdata",sep=""))
  if(savebreakdowns==TRUE){ save(list=c("histfilebreakdown","projfilebreakdown"),file="FileBreakdowns.Rdata") }
}
