...
# Change file formats to GeoTIFFs as needed.

format_change = function(step2_filename,outfiletype){
...
format_change(step2_filename=parsed.args$filename,outfiletype=parsed.args$outfiletype)
