####################
#
# 3^5 Analysis with Number of days > 95F
#
...
for(i in 1:length(filelist)){
  ...
  if(i==1){
    ...
    startdate = as.Date(substr(test$var[[6]]$dim[[3]]$units,12,21),"%Y-%m-%d")
    timeunits = test$var[[6]]$dim[[3]]$units
...
pdf("/home/woot0002/IndividualMembers_tmax95.pdf",onefile=TRUE,width=8,height=8)
...
pdf("/home/woot0002/Group1members_tmax95.pdf",width=8,height=8,onefile=TRUE)
...
pdf("/home/woot0002/Group2Members_tmax95.pdf",onefile=TRUE,width=8,height=8)
...
pdf("/home/woot0002/Group3Members_tmax95.pdf",onefile=TRUE,width=8,height=8)
...
zlimdiff = c(-60,60)
breaksdiff = c(seq(-60,60,by=5))
colorbardiff = colorRampPalette(c("blue","grey96","red"))(length(breaksdiff)-1)

zlimobs = c(0,120)
breaksobs = c(seq(0,120,by=10))
colorbarobs = colorRampPalette(c("yellow2","orange","red","darkred"))(length(breaksobs)-1)

pdf("/home/woot0002/IndividualMembers_tmax95_OK.pdf",onefile=TRUE,width=9,height=6)
...
pdf("/home/woot0002/Group1Members_tmax95_OK.pdf",onefile=TRUE,width=9,height=6)
...
pdf("/home/woot0002/Group2Members_tmax95_OK.pdf",onefile=TRUE,width=9,height=6)
...
pdf("/home/woot0002/Group3Members_tmax95_OK.pdf",onefile=TRUE,width=9,height=6)
