...
area_range = function(step1_filename,histnotes,projnotes,regionname,regiontype,boxXextent,boxYextent,shapefile,shapedimension,areaname){
  ...
  #regionname = "RedRiver"
  #regiontype = "box"
  #boxXextent = "255.05,255.15"
  #boxYextent = "36.05,36.15"
...
area_range(step1_filename=parsed.args$filename,histnotes=parsed.args$histnotes,projnotes = parsed.args$projnotes,regiontype=parsed.args$regiontype,regionname=parsed.args$regionname,boxXextent=parsed.args$boxXextent,boxYextent=parsed.args$boxYextent,shapefile=parsed.args$shapefile,shapedimension=parsed.args$shapedimension,areaname=parsed.args$areaname)
