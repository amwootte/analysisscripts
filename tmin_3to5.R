####################
#
# 3^5 Analysis with Low temperature change
#
...
setwd("/data2/3to5/I35/tasmin/EDQM")
...
for(i in 1:length(filelist)){
  ...
  tempdata = ncvar_get(test,"tasmin")
...
zlimdiff = c(-1,4)
breaksdiff = c(seq(-1,0,by=0.25),seq(0.25,4,by=0.25))
colorbardiff = c(colorRampPalette(c("blue","grey96"))(4),colorRampPalette(c("grey96","red"))(16))
#colorbardiff = colorRampPalette(c("blue","grey96","red"))(length(breaksdiff)-1)

zlimobs = c(260,300)
breaksobs = c(seq(260,300,by=5))
colorbarobs = colorRampPalette(c("yellow2","orange","red","darkred"))(length(breaksobs)-1)

pdf("/home/woot0002/IndividualMembers_tmin.pdf",onefile=TRUE,width=8,height=8)
...
zlimdiff = c(0,3)
breaksdiff = c(seq(0,3,by=0.25))
colorbardiff = colorRampPalette(c("grey96","red"))(length(breaksdiff)-1)

zlimobs = c(260,300)
breaksobs = c(seq(260,300,by=5))
colorbarobs = colorRampPalette(c("yellow2","orange","red","darkred"))(length(breaksobs)-1)

pdf("/home/woot0002/Group1members_tmin.pdf",width=8,height=8,onefile=TRUE)
...
zlimdiff = c(-0.5,3)
breaksdiff = c(seq(-0.5,3,by=0.25))
colorbardiff = c(colorRampPalette(c("blue","grey96"))(2),colorRampPalette(c("grey96","red"))(12))

zlimobs = c(260,300)
breaksobs = c(seq(260,300,by=5))
colorbarobs = colorRampPalette(c("yellow2","orange","red","darkred"))(length(breaksobs)-1)

pdf("/home/woot0002/Group2Members_tmin.pdf",onefile=TRUE,width=8,height=8)
...
zlimdiff = c(0,3.25)
breaksdiff = c(seq(0,3.25,by=0.25))
colorbardiff = colorRampPalette(c("grey96","red"))(length(breaksdiff)-1)
...
pdf("/home/woot0002/Group3Members_tmin.pdf",onefile=TRUE,width=8,height=8)
...
zlimdiff = c(-0.75,3.5)
breaksdiff = c(seq(-0.75,3.5,by=0.25))
colorbardiff = c( colorRampPalette(c("blue","grey96"))(3), colorRampPalette(c("grey96","red"))(14))

zlimobs = c(275,290)
breaksobs = c(seq(275,290,by=5))
colorbarobs = colorRampPalette(c("yellow2","orange","red","darkred"))(length(breaksobs)-1)

pdf("/home/woot0002/IndividualMembers_tmin_OK.pdf",onefile=TRUE,width=9,height=6)
...
zlimdiff = c(0,2.75)
breaksdiff = c(seq(0,2.75,by=0.25))
colorbardiff = colorRampPalette(c("grey96","red"))(length(breaksdiff)-1)
...
pdf("/home/woot0002/Group1Members_tmin_OK.pdf",onefile=TRUE,width=9,height=6)
...
zlimdiff = c(-0.5,3.25)
breaksdiff = c(seq(-0.5,3.25,by=0.25))
colorbardiff = c( colorRampPalette(c("blue","grey96"))(2),colorRampPalette(c("grey96","red"))(13) )

zlimobs = c(275,290)
breaksobs = c(seq(275,290,by=5))
colorbarobs = colorRampPalette(c("yellow2","orange","red","darkred"))(length(breaksobs)-1)

pdf("/home/woot0002/Group2Members_tmin_OK.pdf",onefile=TRUE,width=9,height=6)
...
pdf("/home/woot0002/Group3Members_tmin_OK.pdf",onefile=TRUE,width=9,height=6)
