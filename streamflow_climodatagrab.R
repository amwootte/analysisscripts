...
save(list=c("histfilebreakdown","projfilebreakdown","histresults_climo","projresults_climo"),file=paste("/home/woot0002/CPREP_climo_",gaugenum,"_",futureperiod[1],"-",futureperiod[2],"_fixed.Rdata",sep=""))
