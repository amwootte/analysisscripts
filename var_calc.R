...
var_calc = function(varname,histfilelist,projfilelist,appfunc,difftype,varunits,changeunits,futureperiod,TC,TH,cond,seasonin){
...
var_calc(varname=parsed.args$varname,histfilelist=parsed.args$histlist,projfilelist=parsed.args$projlist,
